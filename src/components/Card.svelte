...
<div class="panel" style="background-color: var({backgroundColor});">
    ...
    {/if}
    <div id="content">
        <slot name="cardContent">Her er kortets innhold, hvis du huska å legge det inn. Om du skal kunne redigere kortet MÅ du huske å subscribe på tilhørende edit-store i cardContent</slot>
    </div>
</div>
