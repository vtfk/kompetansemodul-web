...
{#if tableData.length !== 0}
    ...
    <DataTable style="width: 100%; border:1px solid var(--noytral-3);">
        ...
        <!-- {console.log(tableCritical)} -->
        <Body>
            <!-- {console.log(getCriticalTasks(tempTableData, tempTableCriticalData[0]).length)} -->
                    ...
                    <Row>
                        ...
                        <Cell checkbox style="border-top: 1px solid var(--noytral-3); border-left: 1px solid var(--noytral-3); text-align: center; padding: 8px;">
                            <div class="cell">
                                ...
                                <!-- <p style="margin-left: 1rem"> Satt av:{tempTableData[0].Navn}</p> -->
                            </div>
                        </Cell>
                    </Row>
                {/if}
