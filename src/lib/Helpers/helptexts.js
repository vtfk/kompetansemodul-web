...
+"<br><p>Husk at du også finner informasjon om kartleggingsverktøyet, GDPR og hva informasjon skal brukes til på Innsida, i personvernerklæringen og i andre informasjonskanaler. Dersom du har spørsmål eller noe er uklart er du alltid velkommen til å "
...
+"<br><br>Din utdanning er beskrivende for din formelle kompetanse og er dermed nødvendig i forbindelse med kartleggingen av din kompetanse.</p> <br> "
+"<p>Hvem kan se dette:  </p>" 

// CertificationCard
export const certificationCardHelp = "<p>Kurs og sertifiseringer hvor du har tilegnet deg kompetanse som er relevant.</p> <br> "
+"<p>Hvem kan se dette:  </p>" 

// ExperienceCard
export const experienceCardHelp = "<p>Verv hvor du har tilegnet deg kompetanse som er relevant. </p> <br> "
+"<p>Hvem kan se dette:  </p>" 
