...
+"<br><br><strong>Merk</strong>: Dersom du har en annen stilling i dag enn din hovedstilling vil begge komme opp her, fordi informasjonen hentes fra HRM-systemet. Hovedstillingen står i 0 % fordi du har permisjon fra denne. Stillingen du utfører per i dag kommer opp i stillingsprosenten du faktisk jobber i."
+"<br><br>Noen har andre midlertidige oppgaver, som ikke er knyttet til stillingen din. For eksempel om man er deltaker i et midlertidig prosjekt.  </p>"
...
// WorkExperienceCard
export const workExperienceCardHelp ="<p>Dette feltet omfatter tidligere stillinger du har hatt, dvs. ikke den stillingen du har i VTFK per i dag. Tenk på hva som er relevant for fylkeskommunen å vite.</p><br><p>Hvorfor spør vi om dette? Din arbeidserfaring er èn del av din realkompetanse og er dermed nødvendig i forbindelse med kartlegging av din kompetanse.</p>"
...
// CertificationCard
export const certificationCardHelp = "<p>Kurs og sertifiseringer hvor du har tilegnet deg kompetanse som er relevant og/eller obligatoriske.</p>"
...
// Statistikk 
export const statistikk = "<h3>Statistikk</h3><p>På denne siden kan du få en generell oversikt over en enhet eller en seksjon sin svarprosent for ønsket arbeidssted og kritiske oppgaver. Du kan også se hvilke kritiske oppgaver de ansatte i den aktuelle enheten har. Legg merke til at en enhet/seksjon med underenheter vil vise data for alle underenhetene. Du kan velge å filtrere ut denne dataen ved å trykke på boksen som er plassert rett under dette informasjonskortet. (Boksen vises kun om enheten/seksjonen har underenheter)</p><br><h4>Ønsket arbeidssted kakediagram</h4><p>I dette diagrammet vil du se hva de ansatte i den enheten/seksjonen har svart når det gjelder ønsket arbeidssted.</p><br><h4>Ønsket arbeidssted liggende stolpediagram</h4><p>Dette diagrammet skal illustrere forskjellen mellom dagens arbeidssted og ønsket arbeidssted. Det øverste stolpediagrammet viser ønsket arbeidssted og det nederste diagrammet viser dagens arbeidssted.</p><br><h4>Kritiske oppgaver kakediagram</h4><p>Kritiske Oppgaver diagrammet gir en oversikt over hvor mange ansatte som har kritiske oppgaver i enheten/seksjonen. </p><br><h4>Kritiske oppgaver tabell</h4><p>Kritiske oppgaver tabellen gir deg en oversikt over ansatte sine kritiske oppgaver i den aktuelle enheten. Du har mulighet til å krysse av for hvilke oppgaver du mener er kritiske og lagre dette. Om en beskrivelse av en kritisk oppgave er for stor til å vises i tabellen kan du trykke på knappen «Se beskrivelsen» for å se hele beskrivelsen av den aktuelle kritiske oppgaven. Vær obs på at tabellen og kakediagrammet «Kritiske oppgaver» ikke samsvarer. </p><br>"
